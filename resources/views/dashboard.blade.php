                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        ...
                        <div class="label-chatrs">
                            <div class="">
                                <span class="clabels clabels-lg inline-block bg-orange mr-10 pull-left"></span>
                                <span class="clabels-text font-12 inline-block txt-dark capitalize-font pull-left"><span
                                        class="block font-16 weight-500 mb-5"><span
                                            class="counter-anim">30</span>%</span><span
                                        class="block txt-grey">Male</span></span>
                                <i class="big-rpsn-icon zmdi zmdi-male-alt pull-right txt-orange"></i>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                        <hr class="light-grey-hr row mt-10 mb-15" />
                        <div class="label-chatrs">
                            <div class="">
                                <span class="clabels clabels-lg inline-block bg-success mr-10 pull-left"></span>
                                <span class="clabels-text font-12 inline-block txt-dark capitalize-font pull-left"><span
                                        class="block font-16 weight-500 mb-5"><span
                                            class="counter-anim">70</span>%</span><span
                                        class="block txt-grey">Female</span></span>
                                <i class="big-rpsn-icon zmdi zmdi-female pull-right txt-success"></i>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table  top-countries mb-0">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <span
                                                    class="badge badge-warning transparent-badge weight-500">57%</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <span
                                                    class="badge badge-primary transparent-badge weight-500">51%</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <span
                                                    class="badge badge-warning transparent-badge weight-500">10%</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td class="text-right">
                                                <span
                                                    class="badge badge-success transparent-badge weight-500">27%</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="txt-dark">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="panel panel-default card-view">
                        ...
                        <div class="panel-wrapper collapse in">
                            <div id="e_chart_1" class="" style="height:440px;"></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="pull-left">
                        <div class="dropdown inline-block">
                            <button aria-expanded="false" data-toggle="dropdown"
                                class="btn btn-default btn-outline dropdown-toggle border-none pa-0 font-16"
                                type="button"><span></span><i class="zmdi  zmdi-chevron-down ml-15"></i></button>
                            <ul class="dropdown-menu bullet dropdown-menu-left" role="menu">
                                <li role="presentation"><a href="javascript:void(0)" role="menuitem"><i
                                            class="icon wb-reply" aria-hidden="true"></i>Montreal</a></li>
                                <li role="presentation"><a href="javascript:void(0)" role="menuitem"><i
                                            class="icon wb-reply" aria-hidden="true"></i>Melbourne </a></li>
                                <li role="presentation"><a href="javascript:void(0)" role="menuitem"><i
                                            class="icon wb-reply" aria-hidden="true"></i>Mumbai</a></li>
                                <li role="presentation"><a href="javascript:void(0)" role="menuitem"><i
                                            class="icon wb-share" aria-hidden="true"></i> Washington DC</a></li>
                                <li role="presentation"><a href="javascript:void(0)" role="menuitem"><i
                                            class="icon wb-trash" aria-hidden="true"></i>Tokyo </a></li>
                                <li role="presentation"><a href="javascript:void(0)" role="menuitem"><i
                                            class="icon wb-trash" aria-hidden="true"></i>Los Angeles </a></li>
                                <li role="presentation"><a href="javascript:void(0)" role="menuitem"><i
                                            class="icon wb-trash" aria-hidden="true"></i>Singapore </a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                        ...
                        <div class="sm-data-box bg-white">
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 text-left  pl-0 pr-0 pt-25 data-wrap-right">
                                        <div id="sparkline_5" style="width: 100px; overflow: hidden; margin: 0px auto;">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="panel panel-default card-view">
                <div class="panel-wrapper collapse in">
                    <div class="panel-body sm-data-box-1">
                        <span class="uppercase-font weight-600 font-14 block text-center txt-dark">success index this
                            year</span>
                        ...
                        <div class="progress-anim mt-20">
                            <div class="progress">
                                <div class="progress-bar progress-bar-warning wow animated progress-animated"
                    ...
                    <div class="panel-body">
                        ...
                        <div class="label-chatrs text-center">
                            <div class="inline-block mr-15">
                                ...
                                <span
                                    class="clabels-text font-12 inline-block txt-dark capitalize-font">developer</span>
                            </div>
                            <div class="inline-block mr-15">
                            ...
                            <div class="inline-block">
                                <span class="clabels inline-block bg-success mr-5"></span>
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        ...
                        <div class="label-chatrs">
                            <div class="inline-block mr-15">
                                <span class="clabels inline-block bg-warning mr-5"></span>
                                <span class="clabels-text font-12 inline-block txt-dark capitalize-font">Higher
                                    education</span>
                            </div>
                        </div>
                    </div>
