...
<section class="py-2 bg_light inner_page_mt">
    <div class="container">
        <h5 class="fw-normal">Similar Properties</h5>
        <div class="mt-3">
            <div class="row ">
                <!-- Left list bar  -->
                <div class="col-lg-12 ">
                                    ...
                                    <div class="col-md-3 p-2 list_page_item_width">
                                        <div class="d-flex justify-content-center align-items-center">
                                            <div class="position-relative rounded-3 overflow-hidden">
                                                @if($propertyItem->property->images && $propertyItem->property->images->isNotEmpty())
                                                <img src="{{ asset('images/property_images/'.$propertyItem->property->images[0]->name)}}"
                                                    class="d-block w-100" alt="{{$propertyItem->property->images[0]->aux1}}">
                                                @endif
                                                ...
                                                <div class="bg-dark text-white text-center position-absolute bottom-0 start-0 w-100 fs-10">
                                                    Updated {{ $propertyItem->property->created_at->diffInMonths(now()) }} Month ago
                                                </div>
                                        ...
                                        <div class="mt-2">
                                            <p class="fs-12 m-0">Owner: {{$propertyItem->property->user->name}}</p>
                                        </div>
                                    </div>
                                </a>
                                <div class="flex-grow-1 col-md-6 p-2 px-4">
                                    <div class="mb-3">
                                        <a href="#" class="link_default text_nowrap"><p class="fw-normal mb-1">{{$propertyItem->property->title}}</p></a>
                                    </div>
                                            ...
                                            <div class="col d-flex justify-content-center">
                                                <div class="d-flex align-items-center justify-content-center">
                                                    ...
                                                    <div class="ms-2">
                                                        ...
                                                        <p class="m-0 fs-12 fw-bold">{{$propertyItem->property->property_type->name}}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col d-flex justify-content-center before_verticle_line position-relative">
                                                <div class="d-flex align-items-center justify-content-center">
                                                    ...
                                                    <div class="ms-2">
                                                        ...
                                                        <p class="m-0 fs-12 fw-bold">{{$propertyItem->property->area}}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col d-flex justify-content-center before_verticle_line position-relative">
                                                <div class="d-flex align-items-center justify-content-center">
                                                    ...
                                                    <div class="ms-2">
                                                        ...
                                                        <p class="m-0 fs-12 fw-bold">{{$propertyItem->property->property_view->name}}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="text_nowrap mb-0">{{$propertyItem->property->short_address}}, for {{$propertyItem->property->price}}</p>
                                </div>            
                                <div class="list_page_item_width p-2 bg_light d-flex justify-content-center align-items-center">
                                    <div class="text-center">
                                        <h5 class="mb-4">₹ {{$propertyItem->property->price}}</h5>
                                        <div class="mb-3">
