...
@section('metatitle', $propertytype->aux2)
@section('metadescription', $propertytype->aux3)
@section('metakeyword', $propertytype->aux4)
            ...
            <div class="section_title text-center text-md-start">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active fs-tiny" aria-current="page">{{$propertytypename}}</li>
                    </ol>
                </nav>
                <h3>{{$propertytypename}}</h3>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row position-relative">
            <div class="col-md-9">
                @if($propertiescount != 0)
                        ...
                        <div class="d-md-flex">
                            <div class="img_box image_swiper_box">
                                <div id="carouselItem_{{$property->id}}" class="carousel slide carousel-fade">
                                    ...
                                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselItem_{{$property->id}}"
                                        data-bs-slide="prev">
                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                        <span class="visually-hidden">Previous</span>
                                    </button>
                                    <button class="carousel-control-next" type="button" data-bs-target="#carouselItem_{{$property->id}}"
                                        data-bs-slide="next">
                            ...
                            <div class="content_box d-flex flex-column justify-content-between flex-grow-1 px-3 py-2">
                                <div class="box_wrapper">
                                    <div class="d-flex justify-content-start">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <a href="#" class="link_default">
                                                <div class="hot_offer_box box_default ">{{$property->offer}}% GST</div>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class=" overflow-hidden">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <!--    </div>-->
                                        <!--</div>-->
                                        <a href="{{ route('property', ['propertySlug' => $property->slug]) }}" class="link_default text-white btn_details bg-primaryLight">Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    @endforeach
                @else
                <p>Sorry We Do Not Have Any {{$propertytypename}} For Sale Right Now</p>
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 justify-content-center">
                        <!-- item 1 -->
                        @foreach($pptypes as $propertytype)
                        <a href="{{ url('property-type/'.$propertytype->name)}}" class="archive_list_item link_default text_primary_light">
