<section class="inner_page_mt overlay position-relative">
    <div class="container-fluid p-0 ">
        <div class="p-0 d-sm-none">
            <img src="{{ asset('website/images/home-page-slider-banner-min.png') }}" class="w-100 mt-3" alt="">
        </div>
        <div class="p-0 d-none d-sm-block">
            <img src="{{ asset('website/images/genuineplothomepagebanner.png') }}" alt="Hero Image" class=" w-100 ">
        </div>
    </div>
</section>
