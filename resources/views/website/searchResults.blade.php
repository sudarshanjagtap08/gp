            ...
            <div class="section_title text-center text-md-start">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active fs-tiny" aria-current="page">Search Results</li>
                    </ol>
                </nav>
        ...
        <div class="col-md-8 mb-3">
            <div class="">
                <div class="d-sm-flex justify-content-between align-items-center">
                    ...
                    <div class="d-sm-flex">
                        <!-- <div class="d-flex fs-14 align-items-center mb-3 mb-sm-0">
                            <div class="text_nowrap_item">Sort By :</div>
                            <div
                                class="tt-select bg_none text_nowrap_item no_filter_input_box w-100 ms-1 search_result_sortby_button">
                                <select name="landCity">
                                    <option value="All Cities">Default Order</option>
                                    <option value="Banda">Price - Low to High</option>
                                    <option value="Banda">Price - High to Low</option>
                                    <option value="Banda">Featured Listing First</option>
                                    <option value="Banda">Date - Old to New</option>
                                    <option value="Banda">Date - New to Old</option>
                                </select>
                            </div>
                        </div> -->
                        <!-- <a href="#" class="btn_load_more link_default ms-1 fs-14"><i class="bi bi-bell fs-6"></i> Save
                            Search</a> -->
                    </div>
                </div>
            </div>
