                                    ...
                                    <form action="{{ url('list/landingpage/save')}}" method="post"
                                        ...
                                        <div class="form-body">
                                            <h6 class="txt-dark capitalize-font"><i
                                                    class="zmdi zmdi-account mr-10"></i>Edit Landing Page</h6>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="landing_page_title"
                                                                    class="form-control" value="{{$landingpagedata->landing_page_title}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="landing_page_template"
                                                                    class="form-control" value="{{$landingpagedata->landing_page_template}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="abouttitle"
                                                                    class="form-control" placeholder="" value="{{$landingpagedata->about_title}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="aboutdescription" id=""
                                                                    class="form-control" rows="3">{{$landingpagedata->about_description}}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="contact_number"
                                                                    class="form-control" placeholder="" value="{{$landingpagedata->contact_number}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                value="{{$landingpagedata->contact_email}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="contact_address" id="" rows="3"
                                                                    class="form-control">{{$landingpagedata->contact_address}}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                value="{{$landingpagedata->cta_title}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="cta_description"
                                                                    class="form-control" placeholder="" value="{{$landingpagedata->cta_description}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                                                            ...
                                                                                            <div class="col-md-12">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                        ...
                                                                                                        class="form-control"
                                                                                                        placeholder="" value="{{ $landingpagedata->locations->first()->locationtitleone }}">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-12">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                        ...
                                                                                                        class="form-control" value="{{ $landingpagedata->locations->first()->locationssubtitleone }}"
                                                                                                        placeholder="">
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                            ...
                                                                                            <div class="col-md-12">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                        ...
                                                                                                        class="form-control" value="{{ $landingpagedata->locations->first()->locationtitletwo }}"
                                                                                                        placeholder="">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-12">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                        ...
                                                                                                        class="form-control" value="{{ $landingpagedata->locations->first()->locationssubtitletwo }}"
                                                                                                        placeholder="">
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                            ...
                                                                                            <div class="col-md-12">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                        ...
                                                                                                        class="form-control" value="{{ $landingpagedata->locations->first()->locationtitlethree }}"
                                                                                                        placeholder="">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-12">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                        ...
                                                                                                        class="form-control" value="{{ $landingpagedata->locations->first()->locationssubtitlethree }}"
                                                                                                        placeholder="">
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                            ...
                                                                                            <div class="col-md-12">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                        ...
                                                                                                        class="form-control" value="{{ $landingpagedata->locations->first()->locationtitlefour }}"
                                                                                                        placeholder="">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-12">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                        ...
                                                                                                        class="form-control" value="{{ $landingpagedata->locations->first()->locationssubtitlefour }}"
                                                                                                        placeholder="">
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
