                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-wrap">
                                    <form id="form-blogSubmit" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body">
                                            <h6 class="txt-dark capitalize-font"><i
                                                    class="zmdi zmdi-account mr-10"></i>Edit Blog</h6>
                                            <hr class="light-grey-hr" />
                                            <div class="row">
                                                <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
                                                <input type="hidden" name="blog_id" class="form-control"
                                                    placeholder="" value="{{$blogs->id}}">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label mb-10">Title</label>
                                                        <input type="text" name="title" class="form-control"
                                                            placeholder="" value="{{$blogs->title}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label mb-10">Tag's</label>
                                                        <div class="tag-container mb-2" id="tagContainer">
                                                            @foreach($blogs->blogtags as $blogtag)
                                                                @if ($blogtag->tags)
                                                                    <div class="tag">
                                                                        <span class="tag-text">{{ $blogtag->tags->name }}</span>
                                                        ...
                                                        <div class="tags-filter-box py-2">
                                                            <input type="text" id="tagInput" class="form-control" placeholder="Enter a tag and press Enter">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="short_description" id=""
                                                            rows="2">{{$blogs->short_description}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="checkbox checkbox-primary">
                                                            <input id="checkbox{{ $category->id }}" type="checkbox"
                                                                ...
                                                                @if (in_array($category->id, $blogs->blogcategories->pluck('category_id')->toArray())) checked @endif >
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <img src="{{ asset('images/blog/'.$blogs->image)}}" width="100px" alt="Blog Banner">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group ">
                                                        ...
                                                        <textarea class="tinymce" name="description" id="description"
                                                            rows="5">{{$blogs->description}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
$(document).ready(function() {
    ...
    $("#btn-blogsubmit").click(function(e) {
        ...
        formData.append("blog_id", $("input[name='blog_id']").val());
        ...
        $.ajax({
            ...
            success: function(response) {
                window.location.href = "{{ route('list.blog') }}";
            },
